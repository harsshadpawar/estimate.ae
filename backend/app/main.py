...
import uuid
# from app.database.init_db import seed_roles, seed_subscription_plans,seed_plan_limits, seed_products, seed_countries, seed_country_subscription_plans, seed_machine_master, seed_material_master, seed_material_subgrades
from app.database.init_db import (
    ...
    seed_products,
    seed_countries,
    seed_country_subscription_plans,
    seed_machine_master,
    seed_material_master,
    seed_material_subgrades,
    seed_surface_treatments,
    seed_cutting_parameters
)
...
async def startup_event():
    ...
    EXCE_PATH = os.path.join(BASE_DIR, "config","data","machine_master.xlsx")

    print("Base dir:", BASE_DIR)
    print("EXC_PATH root:", EXCE_PATH)
    ...
    seed_machine_master(db)
    seed_material_master(db)
    seed_material_subgrades(db)
    seed_surface_treatments(db)
    seed_cutting_parameters(db)
