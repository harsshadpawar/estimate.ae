...
# print("✅ Adding MTKConverter to sys.path:", mtk_path)
if mtk_path not in sys.path:
    sys.path.insert(0, mtk_path)

import manufacturingtoolkit.CadExMTK as mtk
from app.cadex.machining.dfm_analyzer.dfm_analyzer import main
...
# import manufacturingtoolkit.CadExMTK as mtk
# Your other imports
# from app.cadex.machining.dfm_analyzer import main
...
def dfm_capture_and_process_output(source_file, operation):
...
if __name__ == "__main__":
    ...
    structured_data = dfm_capture_and_process_output(aSource, anOperation)
    sys.exit(0)