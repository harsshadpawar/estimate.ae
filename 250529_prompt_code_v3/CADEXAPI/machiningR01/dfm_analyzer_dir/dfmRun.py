...
from CADEXAPI.machiningR01.dfm_analyzer_dir import dfm_analyzer
...
def capture_and_process_output(source_file, operation):
    ...
    with redirect_stdout(buffer):
        ...
        dfm_analyzer.main(source_file, operation)
    ...
    # print(output_text)
    txt_file_path = "./outputs/CDEX/DFM/"
    if not os.path.exists(txt_file_path):
        os.makedirs(txt_file_path)
    with open(txt_file_path +"dfm_analysis.txt", "w") as f:
        f.write(output_text)
    ...
    json_file_path = "./outputs/CDEX/DFM/dfm_analysis.json"
...
def main(step_file_path, machining_process):
    # Example usage
    aSource = step_file_path
    anOperation = machining_process
