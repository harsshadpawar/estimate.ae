...
export type UploadFolderProps = {
    onFileSelect: (file: RcFile, fileList: RcFile[]) => Promise<boolean>;
};
...
const UploadFolder: FC<UploadFolderProps> = ({ onFileSelect }) => {
    return (
        <Box sx={{
            width: '100%',
            height: '100%',
            ...
            >
                <UploadBox>
                    ...
                    <Typography variant="body1" sx={{ textAlign: 'center' }} gutterBottom>
                        Drag & drop or click to select your <strong>MTKWEB</strong> folder
                    </Typography>
                </UploadBox>
            </Upload>
            ...
            <Box sx={{ mt: 1, textAlign: "center" }}>
                <Typography variant="caption" color="textSecondary">
                    *Accepted: folders like <strong>MTKWEB</strong>
                </Typography>
                <br />
                <Typography variant="caption" color="textSecondary">
                    *Files inside must be under 10MB
                </Typography>
            </Box>
        </Box>
    );
