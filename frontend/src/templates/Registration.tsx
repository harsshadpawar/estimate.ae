...
const ResgitrationTemplate = () => {
  ...
  return (
    <AuthComponent
      image={SucessReg} // Replace with your image URL
    >
...
export default ResgitrationTemplate;
