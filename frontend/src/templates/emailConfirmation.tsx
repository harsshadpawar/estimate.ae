...
import Registerpanel from "@/assets/images/RegisterPanel.png";
...
const EmailConfirmation = () => {
  return (
    <AuthComponent
      image={Registerpanel} // Replace with your image URL
    >
      ...
      >
        ...
        >
          ...
          <span style={{ color: "#0591FC", textDecoration: "underline" }}>
            xxxxxxxx09@gmail.com
          </span>{" "}
          to confirm the validity of our email address. After receiving the
          email follow the link provided to complete you registration.
        </Typography>
